(function (global, factory) {
  ...
  exports.default = function (config, container) {
    ...
    fragments.definitions = Object.keys(config).reduce(function (acc, key) {
      ...
      return Object.assign({}, acc, _defineProperty({}, key, fragmentConfig.isResource ? (0, _ResourceFragment2.default)(key, fragmentConfig, container) : (0, _Fragment2.default)(key, fragmentConfig, container)));
    }, {});
